...
mod tests {
    ...
    // Packet 3: INIT received from Chrome
    // Note that the INIT chunk length is 0x56, which does not include the last two padding bytes.
    // This was triggering a bug when processing parameters where we first discard the chunk
    // padding, then consider the final parameter buffer to be underrun when it doesn't contain the
    // padding.
    const PACKET_3_BYTES: &[u8] = &[
        0x13, 0x88, 0x13, 0x88, 0x00, 0x00, 0x00, 0x00, 0xf3, 0x5c, 0x57, 0x42, 0x01, 0x00, 0x00, 0x56,
        0x4d, 0x3c, 0x45, 0x1a, 0x00, 0x02, 0x00, 0x00, 0x04, 0x00, 0x08, 0x00, 0xfb, 0xc7, 0x8d, 0x2c,
        0xc0, 0x00, 0x00, 0x04, 0x80, 0x08, 0x00, 0x09, 0xc0, 0x0f, 0xc1, 0x80, 0x82, 0x00, 0x00, 0x00,
        0x80, 0x02, 0x00, 0x24, 0x2b, 0x3a, 0xe9, 0x0b, 0x35, 0x2a, 0x61, 0xce, 0xd8, 0x01, 0x2d, 0x45,
        0x96, 0x4f, 0xd8, 0x26, 0xa3, 0x18, 0x6f, 0x8c, 0x3f, 0xfb, 0xcc, 0xd9, 0xbe, 0x15, 0x5a, 0xb6,
        0x75, 0xd2, 0x6d, 0x2c, 0x80, 0x04, 0x00, 0x06, 0x00, 0x01, 0x00, 0x00, 0x80, 0x03, 0x00, 0x06,
        0x80, 0xc1, 0x00, 0x00
    ];
    ...
    fn test_init_trailing_padding() {
        ...
        assert_eq!(packet.header.destination_port, 5000);
        assert_eq!(packet.header.verification_tag, 0);
    }
}
